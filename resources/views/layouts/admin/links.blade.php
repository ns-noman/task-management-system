...
<!-- DataTables -->
<link rel="stylesheet" href="{{ asset('public/admin-assets') }}/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
...
<link rel="stylesheet" href="{{ asset('public/admin-assets') }}/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
