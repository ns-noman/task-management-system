                    ...
                    <section class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-primary p-1">
                                <h3 class="card-title">
                                    <a href="{{ url('admin/expense/expense-heads-create-or-edit') }}"class="btn btn-light shadow rounded m-0"><i
                                            class="fas fa-plus"></i>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-center">
                                                                <a href="{{ url('admin/expense/expense-heads-create-or-edit/'.$expensehead->id) }}" class="btn btn-info">
