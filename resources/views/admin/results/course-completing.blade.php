...
<style>
    ...
    .pm-certificate-container {
        ...
        .bg-imag {
            background: url('{{ asset('public/uploads/certificate/pad.jpg') }}');
            ...
            <div class="pm-certificate-border col-sm-12">
                <div class="row pm-certificate-header">
                    <div class="pm-certificate-title col-sm-12 text-center">
                        <h2><b>{{ $basicInfo->title }}</b></h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-3 text-center" style="margin-top: 10px"> 
                        <p><strong>SI No- {{ $data['srl_no'] }}</strong></p>
                    </div>
                    <div class="cursive col-sm-6 text-center" style="margin-top: 40px"> 
                ...
                <div class="row pm-certificate-body" style="margin-top: 0px">
                        ...
                        <div class="col-sm-12">
                            <div class="row">
                                ...
                                <div class="pm-earned col-sm-8 text-center">
                                    <span class="block bold sans" style="font-size:20px;">Has Successfully Completed</span>
                                </div>
                                <div class="col-sm-2"></div>
                    ...
                    <div class="col-sm-12 mt-5">
                        <div class="row pm-certificate-footer">
                            ...
                            <div class="col-sm-4 pm-certified text-center">
                                <span class="pm-credits-text block sans">{{ $data['start_date'] }} to {{ $data['end_date'] }}</span>
